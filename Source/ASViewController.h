 ...
 * More importantly, you can use it as a base class for all of your view controllers among which some use a node
 * hierarchy and some don't. See examples/ASDKgram project for actual implementation.
 */
...
@property(nonatomic, copy)
    ASDisplayTraitsForTraitWindowSizeBlock overrideDisplayTraitsWithWindowSize ASDISPLAYNODE_DEPRECATED_MSG(
        "This property is actually never accessed inside the framework");
