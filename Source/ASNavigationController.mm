...
- (NSArray *)popToViewController:(UIViewController *)viewController animated:(BOOL)animated {
  ...
  as_log_info(ASNodeLog(), "Popped %@ to %@, removing %@", self, viewController,
              ASGetDescriptionValueString(viewControllers));
...
- (void)setViewControllers:(NSArray *)viewControllers animated:(BOOL)animated {
  ...
  as_log_info(ASNodeLog(), "Set view controllers of %@ to %@ animated: %d", self,
              ASGetDescriptionValueString(viewControllers), animated);
