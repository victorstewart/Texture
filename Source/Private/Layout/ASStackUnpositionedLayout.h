...
struct ASStackUnpositionedLayout {
  ...
  /**
   * In a single line stack (e.g no wrao), this is the total size of the children in the stack dimension, including all
   * spacing. In a multi-line stack, this is the largest stack dimension among lines.
   */
  ...
  static CGFloat baselineForItem(const ASStackLayoutSpecStyle &style, const ASStackLayoutSpecItem &l);
