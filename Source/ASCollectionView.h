 ...
 */
- (nullable ASCellNode *)supplementaryNodeForElementKind:(NSString *)elementKind
                                             atIndexPath:(NSIndexPath *)indexPath AS_WARN_UNUSED_RESULT;
 ...
 */
@property(nonatomic)
    CGFloat leadingScreensForBatching ASDISPLAYNODE_DEPRECATED_MSG("Use ASCollectionNode property instead.");
 ...
 */
@property(nonatomic, weak) id<ASCollectionViewLayoutInspecting> layoutInspector ASDISPLAYNODE_DEPRECATED_MSG(
    "Use ASCollectionNode property instead.");
...
@property(nonatomic, readonly)
    ASScrollDirection scrollDirection ASDISPLAYNODE_DEPRECATED_MSG("Use ASCollectionNode property instead.");
 ...
 */
@property(nonatomic, readonly)
    ASScrollDirection scrollableDirections ASDISPLAYNODE_DEPRECATED_MSG("Use ASCollectionNode property instead.");
 ...
 */
@property(nonatomic) BOOL zeroContentInsets ASDISPLAYNODE_DEPRECATED_MSG(
    "Set automaticallyAdjustsScrollViewInsets=NO on your view controller instead.");
 ...
 * should begin.
 */
@property(nonatomic, weak) id<ASCollectionDelegate> asyncDelegate ASDISPLAYNODE_DEPRECATED_MSG(
    "Please use ASCollectionNode's .delegate property instead.");
 ...
 */
@property(nonatomic, weak) id<ASCollectionDataSource> asyncDataSource ASDISPLAYNODE_DEPRECATED_MSG(
    "Please use ASCollectionNode's .dataSource property instead.");
...
- (instancetype)initWithCollectionViewLayout:(UICollectionViewLayout *)layout
    ASDISPLAYNODE_DEPRECATED_MSG("Please use ASCollectionNode instead of ASCollectionView.");
...
- (ASRangeTuningParameters)tuningParametersForRangeType:(ASLayoutRangeType)rangeType AS_WARN_UNUSED_RESULT
    ASDISPLAYNODE_DEPRECATED_MSG("Use ASCollectionNode method instead.");
...
- (void)scrollToItemAtIndexPath:(NSIndexPath *)indexPath
               atScrollPosition:(UICollectionViewScrollPosition)scrollPosition
                       animated:(BOOL)animated ASDISPLAYNODE_DEPRECATED_MSG("Use ASCollectionNode method instead.");
...
@property(nonatomic, copy, readonly) NSArray<NSIndexPath *> *indexPathsForVisibleItems ASDISPLAYNODE_DEPRECATED_MSG(
    "Use ASCollectionNode property instead.");

@property(nullable, nonatomic, copy, readonly)
    NSArray<NSIndexPath *> *indexPathsForSelectedItems ASDISPLAYNODE_DEPRECATED_MSG(
        "Use ASCollectionNode property instead.");

/**
 *  Perform a batch of updates asynchronously, optionally disabling all animations in the batch. This method must be
 * called from the main thread. The asyncDataSource must be updated to reflect the changes before the update block
 * completes.
 *
...
- (void)reloadDataWithCompletion:(nullable void (^)(void))completion
    AS_UNAVAILABLE("Use ASCollectionNode method instead.");
...
- (void)waitUntilAllUpdatesAreCommitted ASDISPLAYNODE_DEPRECATED_MSG(
    "Use -[ASCollectionNode waitUntilAllUpdatesAreProcessed] instead.");
...
- (void)moveSection:(NSInteger)section
          toSection:(NSInteger)newSection ASDISPLAYNODE_DEPRECATED_MSG("Use ASCollectionNode method instead.");
...
- (CGSize)calculatedSizeForNodeAtIndexPath:(NSIndexPath *)indexPath
    ASDISPLAYNODE_DEPRECATED_MSG("Call -calculatedSize on the node of interest instead.");
 ...
 *
 * @discussion If you do not implement this method, ASDK will fall back to calling @c
 * collectionView:layout:referenceSizeForHeaderInSection: and using that as the exact constrained size. If you don't
 * implement that method, ASDK will read the @c headerReferenceSize from the layout.
 */
 ...
 *
 * @discussion If you do not implement this method, ASDK will fall back to calling @c
 * collectionView:layout:referenceSizeForFooterInSection: and using that as the exact constrained size. If you don't
 * implement that method, ASDK will read the @c footerReferenceSize from the layout.
 */
...
- (CGSize)collectionView:(ASCollectionView *)collectionView
    ...
    ASDISPLAYNODE_DEPRECATED_MSG("Implement collectionNode:sizeRangeForHeaderInSection: instead.");
...
- (CGSize)collectionView:(ASCollectionView *)collectionView
    ...
    ASDISPLAYNODE_DEPRECATED_MSG("Implement collectionNode:sizeRangeForFooterInSection: instead.");
