                                                ...
                                                textContainer:(NSTextContainer *)textContainer
{
  ...
  NSParagraphStyle *paragraphStyle =
      [textStorage attributesAtIndex:[layoutManager characterIndexForGlyphAtIndex:lastVisibleGlyphIndex]
  ...
  [truncationContext performBlockWithLockedTextKitComponents:^(NSLayoutManager *truncationLayoutManager,
                                                               NSTextStorage *truncationTextStorage,
  ...
  CGFloat truncationMessageX =
      (leftAligned ? CGRectGetMinX(translatedTruncationRect) : CGRectGetMaxX(translatedTruncationRect));
                                                        ...
                                                        textStorage:(NSTextStorage *)textStorage
{
  ...
  [layoutManager
      lineFragmentRectForGlyphAtIndex:[layoutManager glyphIndexForCharacterAtIndex:firstCharacterIndexToReplace]
...
- (void)truncate
{
  [_context performBlockWithLockedTextKitComponents:^(
    ...
    if (visibleCharacterRange.length < originalStringLength && self->_truncationAttributedString.length > 0) {
      ...
      NSRange truncationReplacementRange =
          NSMakeRange(firstCharacterIndexToReplace, textStorage.length - firstCharacterIndexToReplace);
